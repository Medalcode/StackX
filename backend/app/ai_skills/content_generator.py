...
DESCRIPTION = (
    "Super-Skill para generar contenido variable"
    " (justificaciones, resúmenes, trade-offs) basado en parámetros."
)
...
async def run_skill(input: dict) -> dict:
    ...
    if mode == "full_justification":
        text = (
            f"Justificación completa: {tech_name} es ideal"
            " por su escalabilidad y soporte de comunidad."
        )
